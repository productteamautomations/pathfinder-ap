...
export function WelcomePage({ name, url, onNameChange, onUrlChange, onContinue }: WelcomePageProps) {
    ...
    class WavyLine {
      ...
      draw(ctx: CanvasRenderingContext2D) {
        ...
        if (this.index === numLines - 1) {
          ...
          gradient.addColorStop(0, `rgba(227, 102, 79)`);
          gradient.addColorStop(1, `rgba(227, 102, 79)`);
        ...
        ctx.strokeStyle = `rgba(227, 102, 79)`;
      ...
      <div className="relative z-20 min-h-screen flex items-center justify-center p-6">
        ...
        <div className="w-full max-w-md relative">
          <div className="text-center mb-8 smooth-entrance">
            ...
            <p className="text-xl text-deep-blue opacity-70">Find the right path for you</p>
          </div>
