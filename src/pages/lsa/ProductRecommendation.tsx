      ...
      >
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-border/20 mb-4">
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1">
              <p className="text-base font-semibold text-foreground">Google Guaranteed</p>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-border/20 mb-4 ml-6">
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1">
              <p className="text-base font-semibold text-foreground">Background Checked</p>
              <p className="text-sm text-muted-foreground">Fully verified business</p>
            </div>
            <span className="text-sm font-bold text-blue-500 bg-blue-50 px-3 py-1.5 rounded-full">Secure</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-border/20 ml-3">
          <div className="flex items-center gap-5">
            ...
            <div className="flex-1">
              <p className="text-base font-semibold text-foreground">Pay Per Lead</p>
              <p className="text-sm text-muted-foreground">Only valid enquiries</p>
            </div>
            <span className="text-sm font-bold text-primary bg-primary/10 px-3 py-1.5 rounded-full">Smart</span>
          </div>
        </div>
