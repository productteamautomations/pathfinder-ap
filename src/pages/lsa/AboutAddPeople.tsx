...
const leadgenReviews = [
  ...
  },
  {
    name: "Josh",
    review:
      "Add People have been instrumental in the development of our digital strategy and growth of our business in the last 2 years that we've been working together.",
    rating: 5,
  },
  {
    name: "Nick Brown",
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-background relative" style={{ containerType: "size" }}>
      ...
      <div
        ...
        style={{ paddingTop: "10cqh", paddingLeft: "4cqw", paddingRight: "4cqw", paddingBottom: "2cqw" }}
      >
        <div
          style={{
            width: "100%",
                  ...
                  <div className="flex items-center" style={{ gap: "1.5cqw" }}>
                    <div>
                      ...
                      <p
                        ...
                        style={{ fontSize: "0.9cqw", marginTop: "0.2cqw", maxWidth: "18cqw" }}
                      >
