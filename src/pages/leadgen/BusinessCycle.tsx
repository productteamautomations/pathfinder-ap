                                  ...
                                  <motion.li
                                    ...
                                    className={`shadow-[0_2px_10px_rgba(0,0,0,0.04)] border border-border/30 ${
                                      item.isExample
                                        ...
                                        : item.isInteractive
                                          ? "flex bg-accent/10 items-center cursor-pointer hover:bg-accent/20 hover:border-accent/50 hover:shadow-[0_4px_15px_rgba(0,0,0,0.08)] transition-all duration-200"
