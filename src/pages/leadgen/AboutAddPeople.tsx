            ...
            <div className="flex-1 flex flex-col gap-2">
              ...
              {leadgenReviews.map((review, idx) => (
                <motion.div
                  ...
                  className="bg-white/95 backdrop-blur-sm rounded-xl p-3 border border-border/30 shadow-sm flex-1 flex flex-col justify-center"
                >
                  ...
                  <p className="text-xs text-foreground leading-snug mb-1 line-clamp-2">"{review.review}"</p>
                  <div className="flex items-center gap-1">
                    <span className="text-xs font-semibold text-[#173340]">{review.name}</span>
                    <span className="text-[10px] text-muted-foreground">• {review.company}</span>
                  </div>
                </motion.div>
              ))}
            </div>
