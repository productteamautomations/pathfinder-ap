...
export default function AboutAddPeopleLeadGen() {
  ...
  return (
    <div className="min-h-screen h-screen flex flex-col overflow-hidden" style={{ containerType: "size" }}>
      <PageHeader
      ...
      <div className="flex-1 pt-[73px] flex items-center justify-center overflow-hidden" style={{ padding: "0 3cqw" }}>
        <div className="grid lg:grid-cols-[1.5fr_1fr] w-full mx-auto" style={{ gap: "2cqw", maxWidth: "140cqw" }}>
          {/* Left - Main Image */}
