      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="fixed top-[73px] left-0 right-0 z-40 px-6 py-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <h1 className="text-3xl font-bold text-primary">Required Information</h1>
              <p className="text-sm text-muted-foreground mt-1">
                Final step! Please provide the following details
              </p>
            </motion.div>
          </div>
        </div>
              ...
              <div className="grid md:grid-cols-2 gap-5">
                ...
                >
                  <GlassCard className="p-6 h-full">
                    <h2 className="text-xl font-bold text-foreground mb-5">Client Details</h2>
                ...
                >
                  <GlassCard className="p-6 h-full">
                    <h2 className="text-xl font-bold text-foreground mb-5">Website Login Details</h2>
                    <div className="space-y-4">
                      <Input
                        label="Username"
                        value={username}
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="relative">
                          <input
                            ...
                            required
                            className="w-full px-4 py-3 pr-12 rounded-lg border border-border bg-white text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200"
                          />
                          <button
                            type="button"
        ...
        <div className="fixed bottom-0 left-0 right-0 z-40 px-6 py-5">
          <div className="max-w-4xl mx-auto text-center">
            <Button onClick={handleSubmit} disabled={!allValid} className="px-16">
              Complete Setup
            </Button>
